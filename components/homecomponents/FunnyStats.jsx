        ...
        <div className='bg-white rounded-lg mt-5'>
            <div className='max-w-6xl mx-auto py-14 px-5 2xl:px-14'>
                <div className=''>
                    ...
                    {/* last_stargazer_start_JSX */}<a href="https://github.com/rousalahtinen"><img src="https://avatars.githubusercontent.com/u/143646724?v=4&s=250"
                  target="_blank"/></a>{/* last_stargazer_end_JSX */}
                    ...
                    <p className=' pt-2 text-gray-600 text-center'>
                        Thanks to
                        {/* name_start_JSX */}<a
                            href="https://github.com/rousalahtinen"
                            target="_blank"
                            className='text-[#0D94B6] hover:underline'
                        > rousalahtinen </a>{/* name_end_JSX */}
                        for starring the repository! 🎉
                    </p>
                    <p className=' pt-2 text-gray-600 font-bold '>
                        Star Count: <span className='text-[#0D94B6] font-bold'>{/* stars_start */}750{/* stars_end */}</span> 🌟
                    </p>
                    <p className=' pt-2 text-gray-600 font-bold '>
                        Updates occur hourly. Last update : <span className=' font-normal'> {/* date_start_JSX */}16.08.2024, 12:14:27{/* date_end_JSX */} (CET)</span>
                    </p>
