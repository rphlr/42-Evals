            ...
            <div className='max-w-6xl mx-auto py-14 px-5 2xl:px-14'>
                <div className=''>
                    ...
                    <div className="flex justify-center items-center">
                        {/* last_stargazer_start_JSX */}<a href="https://github.com/kebin-rn"><img src="https://avatars.githubusercontent.com/u/69067099?v=4&s=250"
                  target="_blank"/></a>{/* last_stargazer_end_JSX */}
                    ...
                    <p className=' pt-2 text-gray-600 text-center'>
                        Thanks to
                        {/* name_start_JSX */} <a
                            href="https://github.com/kebin-rn"
                            target="_blank"
                            className='text-[#0D94B6] hover:underline'
                        >kebin-rn</a> {/* name_end_JSX */}
                    ...
                    <p className=' pt-2 text-gray-600 font-bold '>
                        Updates occur hourly. Last update : <span className=' font-normal'> {/* date_start_JSX */}20.11.2024, 16:19:46{/* date_end_JSX */} (CET)</span>
                    </p>
