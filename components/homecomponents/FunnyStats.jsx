            ...
            <div className='max-w-6xl mx-auto py-14 px-5 2xl:px-14'>
                <div className=''>
                    ...
                    <div className="flex justify-center items-center">
                        {/* last_stargazer_start_JSX */}<a href="https://github.com/leanor13"><img src="https://avatars.githubusercontent.com/u/4092240?v=4&s=250"
                  target="_blank"/></a>{/* last_stargazer_end_JSX */}
                    ...
                    <p className=' pt-2 text-gray-600 text-center'>
                        Thanks to
                        {/* name_start_JSX */} <a
                            href="https://github.com/leanor13"
                            target="_blank"
                            className='text-[#0D94B6] hover:underline'
                        >leanor13</a> {/* name_end_JSX */}
                    ...
                    <p className=' pt-2 text-gray-600 font-bold '>
                        Updates occur hourly. Last update : <span className=' font-normal'> {/* date_start_JSX */}07.09.2024, 18:14:39{/* date_end_JSX */} (CET)</span>
                    </p>
