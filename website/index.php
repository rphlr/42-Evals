		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				...
				<div class="dancer from-down" id="funny-stats">
					...
					<center>
						<b>Last stargazer:</b>
						<p><!--last_stargazer_start_HTML--><a href="https://github.com/Damoc1ess"><img
                  src="https://avatars.githubusercontent.com/u/151615548?v=4&s=250"
                  target="_blank"></a><!--last_stargazer_end_HTML-->
						</p>
						<p>Thanks to <!--name_start_HTML--><a href="https://github.com/Damoc1ess">Damoc1ess</a><!--name_end_HTML-->
							for starring the repository! 🎉</p>
					</center>
					<b>Star Count: <a href="https://github.com/rphlr/42-Evals"
							target="_blank"><!--stars_start-->737<!--stars_end--></a> 🌟</b>
					<br />
					<p><b>Updates occur hourly. Last update :</b> <!--date_start_HTML-->31.07.2024, 03:15:34<!--date_end_HTML-->
						(CET)</p>
					<center>
						<div>
