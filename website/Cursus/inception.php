		...
		<div class="row mt-4">
			...
			<form class="simple_form form-horizontal" novalidate="novalidate" id="edit_scale_team_6211442"
				...
				<div class="col-sm-12 scale-div">
						...
						<div class="form-group radio_buttons optional scale_team_flag"><label
							...
							<div class="col-sm-10"><span class="radio"><label for="scale_team_flag_id_1"><input
									...
									class="radio"><label for="scale_team_flag_id_3"><input
										...
										work</label></span><span class="radio"><label for="scale_team_flag_id_7"><input
											class="radio_buttons optional" type="radio" value="7"
					...
					<div class="scale-final-comments" id="comments-30064">
