        ...
        <div className='bg-white rounded-lg mt-5'>
            <div className='max-w-6xl mx-auto py-14 px-5 2xl:px-14'>
                <div className=''>
                    ...
                    {/* last_stargazer_start_JSX */}<a href="https://github.com/FizzYxWizzY"><img src="/110629446.png" alt="2020rshah's Blue Github Chart" /></a>{/* last_stargazer_end_JSX */}
                    </div>
                    ...
                    <p className=' pt-2 text-gray-600 text-center'>
                        ...
                        > LipschitzIsSoEasy </a>{/* name_end_JSX */}
                        for starring the repository! 🎉
                    </p>
                    <p className=' pt-2 text-gray-600 font-bold '>
                        Star Count: <span className='text-[#0D94B6] font-bold'>{/* stars_start */}741{/* stars_end */}</span> 🌟
                    </p>
                    <p className=' pt-2 text-gray-600 font-bold '>
                        Updates occur hourly. Last update : <span className=' font-normal'> {/* date_start_JSX */}08.08.2024, 20:12:45{/* date_end_JSX */} (CET)</span>
                    </p>
