...
function page({ params }) {
    ...
    console.log('Mandatory options data from server', mandatoryOptionsDataFromServer)
    ...
    const submitForm = (data) => {
        ...
        for (let i = 0; i < numberOfMandatorySections; i++) {
            newMandatoryOptionsData.push({
                ...
                description: data.description[i] ? data.description[i].split('\n') : mandatoryOptionsDataFromServer[i].description,
                yes_no: data.yes_no[i] === 'true' ? true : false || mandatoryOptionsDataFromServer[i].yes_no || false
            })
        }
