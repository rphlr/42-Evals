...
export default function ProfilePage() {
  ...
  if (loading) {
    return <div className='bg-gray-100 text-gray-900 text-center min-h-screen py-24 px-5 2xl:px-0'>Loading...</div>;
  }

  if (!userData) {
    return <div className='bg-gray-100 text-gray-900 text-center min-h-screen py-24 px-5 2xl:px-0'>
  ...
  return (
    <div className='bg-gray-100 text-gray-900 min-h-screen px-5 2xl:px-0'>
      <div className="max-w-7xl mx-auto pb-20 pt-10">
        <h1 className='text-3xl font-bold text-center mb-10'>Welcome, {userData.login}</h1>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className='lg:w-1/2 mx-auto bg-white rounded-2xl p-7 lg:p-10 flex flex-col gap-2 shadow'>
